...
//	protected Object childHolder;
	...
	public E getChild(int groupPosition, int childPosition) {
		...
		return (E) ((com.dqgb.MPlatform.widget.list.ExpandList.ParentVo) vo).getChildren().get(
				childPosition);
	}
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		if (convertView == null) {
			...
			Object childHolder = buildChildHolder(convertView);
	...
	public int getChildrenCount(int groupPosition) {
		...
		return ((com.dqgb.MPlatform.widget.list.ExpandList.ParentVo) parentData
	...
	public View getGroupView(final int groupPosition, boolean isExpanded,
		...
		if (convertView == null) {
			...
			Object parentHolder = buildParentHolder(convertView);
	...
	public void addChilds(int groupPosition, List<E> childs) {
		((com.dqgb.MPlatform.widget.list.ExpandList.ParentVo) parentData.get(groupPosition))
				.addChildren(childs);
		notifyDataSetChanged();
	}
